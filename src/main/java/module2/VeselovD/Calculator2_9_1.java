...
public class Calculator2_9_1 {
    ...
    public static void main(String[] args) {
        ...
        do {
            if (operation == 'C') {
                System.out.println("Введите первый операнд (чило вводится через ',' например '2,7'):");
            ...
            if (operation != 's' && operation != 'C') {
                System.out.println("Введите второй операнд(чило вводится через ',' например '2,7'):");
